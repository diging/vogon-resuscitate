...
urlpatterns = [
    ...
    re_path(r'^repository/(?P<repository_id>[0-9]+)/group/(?P<group_id>[a-zA-Z0-9]+)/text/(?P<text_id>[0-9]+)/$', views.repository_views.repository_text_import, name='repository_text_import'),
