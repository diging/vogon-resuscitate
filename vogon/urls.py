...
urlpatterns = [
    ...
    re_path(r'^repository/(?P<repository_id>[0-9]+)/collection/(?P<group_id>[0-9]+)/group-collection/(?P<group_collection_id>[a-zA-Z0-9]+)/subcollections/$', views.repository_views.subcollections, name='subcollections'),
